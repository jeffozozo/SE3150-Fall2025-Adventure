...
class Room:
    ...
    def __init__(self):
        self.room_num = 0
        self.description = "Empty Room 2."

        #exits only west, the only way up is if you use the machine.    
        self.exits = ["west"]
    ...
    def show_hint(self):
        if self.in_box:
            print("you have no idea what pushing that button might do. But? won't it be fun to find out?")
        else:
